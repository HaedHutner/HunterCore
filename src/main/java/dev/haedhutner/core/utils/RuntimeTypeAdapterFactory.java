 ...
 * }</pre>
 * Next registerObjects all of your subtypes. Every subtype must be explicitly registered. This protects
 ...
 * }</pre>
 * Finally, registerObjects the type adapter factory in your application's GSON builder:
 * <pre>   {@code
 *   Gson dev.haedhutner.core.gson = new GsonBuilder()
            ...
            public void write(JsonWriter out, R value) throws IOException {
                ...
                if (delegate == null) {
                    throw new JsonParseException("cannot serialize " + srcType.getName()
                            + "; did you forget to registerObjects a subtype?");
                }
