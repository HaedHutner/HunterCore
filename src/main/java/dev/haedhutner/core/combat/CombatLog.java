package dev.haedhutner.core.combat;
    ...
    public void init() {
        cleanup = Task.builder()
                ...
                .execute(() -> {
                    ...
                    log.removeIf(entry -> (currentMillis - entry.getInitiationTime()) >= HunterCore.getConfig().COMBAT_LIMIT.toMillis());
                })
                .submit(HunterCore.getInstance());
    }
