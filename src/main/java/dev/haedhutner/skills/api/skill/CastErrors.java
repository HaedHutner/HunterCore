...
public final class CastErrors {
    ...
    public static CastException insufficientResources(Castable castable, String resourceName) {
        return exceptionOf("You do not have enough ", resourceName, TextColors.RED, " to cast ", castable.getName()
        );
    }
